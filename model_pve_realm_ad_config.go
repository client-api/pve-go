...
func NewPveRealmAdConfig(realm string, server1 string, domain string, type_ string) *PveRealmAdConfig {
...
func (o *PveRealmAdConfig) GetAudiences() string {
...
func (o *PveRealmAdConfig) GetAudiencesOk() (*string, bool) {
	if o == nil || IsNil(o.Audiences) {
		return nil, false
	}
...
func (o *PveRealmAdConfig) HasAudiences() bool {
	if o != nil && !IsNil(o.Audiences) {
		return true
	}
...
func (o *PveRealmAdConfig) SetAudiences(v string) {
	o.Audiences = &v
}


// GetCheckConnection returns the CheckConnection field value if set, zero value otherwise.
func (o *PveRealmAdConfig) GetCheckConnection() PveBoolean {
...
// and a boolean to check if the value has been set.
func (o *PveRealmAdConfig) GetCheckConnectionOk() (*PveBoolean, bool) {
	if o == nil || IsNil(o.CheckConnection) {
		return nil, false
	}
...
func (o *PveRealmAdConfig) HasCheckConnection() bool {
	if o != nil && !IsNil(o.CheckConnection) {
		return true
	}
...
func (o *PveRealmAdConfig) SetCheckConnection(v PveBoolean) {
	o.CheckConnection = &v
}


// GetRealm returns the Realm field value
func (o *PveRealmAdConfig) GetRealm() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PveRealmAdConfig) GetRealmOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Realm, true
...
func (o *PveRealmAdConfig) SetRealm(v string) {
	o.Realm = v
}
